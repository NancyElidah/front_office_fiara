...
import CouleurService from "../service/CouleurService";
class CouleurRecherche extends Component{
    constructor (props){
        super(props);
        this.state = {
            type:[],
                        ...
                        <div className="page-header">
					        <div className="clearfix">
						        <div className="pull-left">
                                    <h4 className="text-blue h4" style={{color:"blue"}}>Couleur</h4>
                                    <p className="mb-20" style={{fontSize:10}}>Faire une recherche à partir d'une Couleur de voiture</p>
						        </div>
                            </div>
                    <form>
                    <div class="form-group row" style={{marginLeft:50}}>
							<label class="col-sm-12 col-md-2 col-form-label">Couleur</label>
...
export default withNavigateHook(CouleurRecherche) ; 