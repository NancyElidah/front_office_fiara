                        ...
                        <div className="page-header">
					        <div className="clearfix">
						        <div className="pull-left">
                                    <h4 className="text-blue h4" style={{color:"blue"}}>Type</h4>
                                    <p className="mb-20" style={{fontSize:10}}>Faire une recherche à partir d'une type de voiture</p>
						        </div>
                            </div>
                    <form>
...
export default withNavigateHook(TypeRecherche) ; 